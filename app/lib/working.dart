  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: _selectedIndex == 0
          ...
          : _selectedIndex == 3
          ? Task() // Display the Task widget for the Activity tab
          : ProfilePage(), // Display the ProfilePage for the Profile tab
      ...
      children: [
        ListView.builder(
          ...
          itemBuilder: (context, index) => ActivityCard(
            ...
            streak: activities[index].streak.toString(),
            ...
            children: [
              ...
              FutureBuilder<int>(
                ...
                builder: (context, snapshot) => Text(
                    "Coins: ${snapshot.hasData ? snapshot.data : '100'}",
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset(
                'images/emotes/like.png',
                width: 30,
                height: 30,
              ),
              Image.asset(
                'images/emotes/fire.png',
                width: 30,
                height: 30,
              ),
            ],
...
class TaskSelectionScreen extends StatelessWidget {
  ...
  void _sendToServer(ActivityCard activityCard) async {
    ...
    final request = http.MultipartRequest('POST', url)
      ...
      ..fields['streak'] = activityCard.streak.toString()
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String profileImage = 'assets/images/mikeWazowski.webp';

  @override
  void initState() {
    super.initState();
    nameController.text = 'Aastha Joshi';
    bioController.text = 'Go do your own thing';
  }
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Name and Bio Fields (existing code)
            TextField(
            ...
            // Navigate to Task Page using Get.to()
            //
